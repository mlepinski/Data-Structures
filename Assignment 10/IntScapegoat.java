...
//You should edit this code to make sure that as you insert into the tree
// ... that the tree stays balanced (using the Scapegoat Tree approach)

//Initially, this code is identical to IntSearchTree

public class IntScapegoat implements IntDataSet{
    int data;
    int height;
    int size;
    IntScapegoat leftChild;
    IntScapegoat rightChild;
	...
	if(leftChild == null){
	    leftChild = new IntScapegoat(value);
	}
	else{
	...
	if(rightChild == null){
	    rightChild = new IntScapegoat(value);
	}
	else{
    ...
    public IntScapegoat(int the_data){
	data = the_data;
	height = 1;
	size = 1;
	leftChild = null;
